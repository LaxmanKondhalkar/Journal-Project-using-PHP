                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputText" placeholder="Journal Title">
                                </div>
                                <div class="mb-3">
                                    <!-- <label for="message-text" class="col-form-label">Message:</label> -->
                                    <textarea class="form-control" id="message-text" placeholder="Write journal here..."></textarea>
                                </div>
