...
<!-- 
                    ...
                    <div class="collapse navbar-collapse " id="myNavbar">
                        ...
                        <ul class="navbar-nav  w-100 d-flex justify-content-around">          
                            <li class="nav-item ">
                                <a class="nav-link  px-4 fs-5 nav-anchor <?php echo ($page == "user_journal.php" ? "active-nav-link" : "" )?> " 
                                    href="user_journal.php">Journals</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link px-4 fs-5 nav-anchor <?php echo ($page == "user_events.php" ? "active-nav-link" : "" )?>" 
                                href="user_events.php">Events</a>
                            </li>
                            <!-- <li class="nav-item ">
